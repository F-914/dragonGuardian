...
---
local TowerCommodityNode = class("TowerCommodityNode", function()
...
function TowerCommodityNode:initView()
    ...
    --
    -- 根据塔的id填充背景
    local button = ccui.Button:create(ConstDef.ICON_TOWER_FRAGMENT[self.commodity_:getCardId()])
    ...
    fragmentBase:setPosition(size.width * 20 / 19, ConstDef.SHOP_ITEM_HEIGHT * 5 / 6)
