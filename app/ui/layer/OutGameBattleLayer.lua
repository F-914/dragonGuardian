...
function OutGameBattleLayer:init()
    ...
    local selectedTeamSprite = display.newSprite(StringDef.PATH_BASE_SELECTED_TEAM)
    selectedTeamSprite:setPosition(display.width * .5, display.height * .08)
    selectedTeamSprite:addTo(teamLayer)
